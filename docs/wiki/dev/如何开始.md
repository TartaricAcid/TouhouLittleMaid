...
目前女仆模组最新版本为 **1.5.2**，支持 **Forge 1.20.1** 和 **NeoForge 1.21.1** 两大平台。
...
- 1.20.1 Forge：`1.5.2-forge+mc1.20.1`
- 1.21.1 NeoForge：`1.5.2-neoforge+mc1.21.1`
