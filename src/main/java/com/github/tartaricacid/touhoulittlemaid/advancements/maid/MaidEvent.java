...
public final class MaidEvent {
    ...
    public static final String MAID_DEATH = "maid_death";
    public static final String SHRINE_REBORN_MAID = "shrine_reborn_maid";
    public static final String MAID_FAVORABILITY_INCREASED= "maid_favorability_increased";
}
