...
public class TombstoneBauble implements IMaidBauble {
    ...
    public boolean onDropsPre(AbstractEntityMaid maid, ItemStack baubleItem) {
        ...
        // 女仆手办
        ItemStack garageKit = BlockGarageKit.getItemStackWithData("touhou_little_maid:entity.passive.maid",
        ...
        if (te instanceof TileEntityTombstone && maidCapability != null) {
            ...
            tombstone.handler.setStackInSlot(maidCapability.getSlots(), garageKit);
            tombstone.refresh();
