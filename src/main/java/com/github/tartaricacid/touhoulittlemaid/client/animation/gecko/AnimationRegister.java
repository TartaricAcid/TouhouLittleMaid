...
public class AnimationRegister {
    ...
    public static void setParserValue(AnimationEvent<?> animationEvent, MolangParser parser, EntityModelData data, IMaid maid) {
        ...
        parser.setValue("query.is_jumping", () -> MolangUtils.booleanToFloat(!mob.isPassenger() && !mob.isOnGround() && !mob.isInWater()));
        parser.setValue("query.is_on_fire", () -> MolangUtils.booleanToFloat(mob.isOnFire()));
        parser.setValue("query.is_on_ground", () -> MolangUtils.booleanToFloat(mob.isOnGround()));
        ...
        parser.setValue("query.is_sneaking", () -> MolangUtils.booleanToFloat(mob.isOnGround() && mob.getPose() == Pose.CROUCHING));
        ...
        parser.setValue("ysm.is_sneak", () -> MolangUtils.booleanToFloat(mob.isOnGround() && mob.getPose() == Pose.CROUCHING));
