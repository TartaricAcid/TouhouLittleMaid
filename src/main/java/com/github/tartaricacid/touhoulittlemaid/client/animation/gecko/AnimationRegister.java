...
public class AnimationRegister {
    ...
    public static void setParserValue(AnimationEvent<GeckoMaidEntity> animationEvent, MolangParser parser, EntityModelData data, EntityMaid maid) {
        ...
        parser.setValue("query.body_x_rotation", () -> maid.xRot);
        parser.setValue("query.body_y_rotation", () -> MathHelper.wrapDegrees(maid.yRot));
        ...
        parser.setValue("query.is_eating", () -> MolangUtils.booleanToFloat(maid.getUseItem().getUseAnimation() == UseAction.EAT));
        parser.setValue("query.is_first_person", () -> MolangUtils.booleanToFloat(mc.options.getCameraType() == PointOfView.FIRST_PERSON));
        ...
        parser.setValue("ysm.has_helmet", () -> getSlotValue(maid, EquipmentSlotType.HEAD));
        parser.setValue("ysm.has_chest_plate", () -> getSlotValue(maid, EquipmentSlotType.CHEST));
        parser.setValue("ysm.has_leggings", () -> getSlotValue(maid, EquipmentSlotType.LEGS));
        parser.setValue("ysm.has_boots", () -> getSlotValue(maid, EquipmentSlotType.FEET));
        parser.setValue("ysm.has_mainhand", () -> getSlotValue(maid, EquipmentSlotType.MAINHAND));
        parser.setValue("ysm.has_offhand", () -> getSlotValue(maid, EquipmentSlotType.OFFHAND));

        parser.setValue("ysm.has_elytra", () -> MolangUtils.booleanToFloat(maid.getItemBySlot(EquipmentSlotType.CHEST).getItem() == Items.ELYTRA));
    ...
    private static float getGroundSpeed(EntityMaid maid) {
        Vector3d velocity = maid.getDeltaMovement();
