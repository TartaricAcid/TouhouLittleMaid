...
public class ModelSwitcherGui extends Screen {
    ...
    private void addEditButton() {
        ...
        this.addRenderableWidget(new Button(leftPos + 55, topPos + 15, 76, 20, Component.translatable("gui.touhou_little_maid.button.skin"), b -> CacheIconManager.openModelSwitcherModelGui(maid, info, this)));
