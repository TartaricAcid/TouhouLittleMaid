...
public class MiddleBackpackContainerScreen extends AbstractMaidContainerGui<MiddleBackpackContainer> implements IBackpackContainerScreen {
    private static final ResourceLocation BACKPACK = ResourceLocation.fromNamespaceAndPath(TouhouLittleMaid.MOD_ID, "textures/gui/maid_gui_backpack.png");
    private final EntityMaid maid;

    public MiddleBackpackContainerScreen(MiddleBackpackContainer container, Inventory inv, Component titleIn) {
