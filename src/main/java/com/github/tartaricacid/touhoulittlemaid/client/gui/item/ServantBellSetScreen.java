...
public class ServantBellSetScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(middleX - 100, middleY + 10, 98, 20, Component.translatable("gui.done"), this::sendDoneMessage));
        this.addRenderableWidget(new Button(middleX + 4, middleY + 10, 98, 20, Component.translatable("gui.cancel"), b -> onClose()));
    }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (textField.getValue().isEmpty()) {
            drawString(poseStack, font, Component.translatable("gui.touhou_little_maid.servant_bell.edit_box").withStyle(ChatFormatting.ITALIC), middleX - 94, middleY - 20, ChatFormatting.DARK_GRAY.getColor());
        }
        drawCenteredString(poseStack, font, Component.translatable("tooltips.touhou_little_maid.servant_bell.uuid", this.maidUuid.toString()), middleX, middleY - 50, 0xFFFFFF);
