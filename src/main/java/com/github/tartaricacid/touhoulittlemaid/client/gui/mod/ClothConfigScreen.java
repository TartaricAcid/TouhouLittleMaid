...
public class ClothConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(posX, posY - 15, 200, 20, Component.translatable("gui.touhou_little_maid.cloth_config_warning.download"), b -> openUrl(clothConfigUrl)));
