...
public class OptifineScreen extends Screen {
    ...
    private final MutableComponent text = new TranslatableComponent("gui.touhou_little_maid.optifine_warning.text");
    ...
    public OptifineScreen(Screen lastScreen) {
        super(new TranslatableComponent("gui.touhou_little_maid.optifine_warning.title").withStyle(ChatFormatting.DARK_RED).withStyle(ChatFormatting.UNDERLINE));
    ...
    protected void init() {
        super.init();
        this.addRenderableWidget(new Button(this.width / 2 - 155, this.height * 3 / 4 - 15, 150, 20, new TranslatableComponent("gui.touhou_little_maid.optifine_warning.embeddium"), b -> openUrl(embeddiumUrl)));
        this.addRenderableWidget(new Button(this.width / 2 + 5, this.height * 3 / 4 - 15, 150, 20, new TranslatableComponent("gui.touhou_little_maid.optifine_warning.oculus"), b -> openUrl(oculusUrl)));
