...
public class MaidSoundPackGui extends Screen {
    ...
    public void render(PoseStack poseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        drawCenteredString(poseStack, font, Component.translatable("gui.touhou_little_maid.custom_sound.pack.title"), startX + 120, startY + 6, 0xFFFFFF);
        drawCenteredString(poseStack, font, Component.translatable("gui.touhou_little_maid.custom_sound.sounds.preview"), startX + 321, startY + 6, 0xFFFFFF);
