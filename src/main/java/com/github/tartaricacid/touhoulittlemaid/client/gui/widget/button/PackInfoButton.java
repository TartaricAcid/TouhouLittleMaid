...
public class PackInfoButton extends FlatColorButton {
    ...
    public PackInfoButton(int pX, int pY, DownloadInfo info, OnPress onPress) {
        super(pX, pY, 268, 46, TextComponent.EMPTY, onPress);
        this.info = info;
    ...
    public void renderString(PoseStack poseStack, Font font, int pColor) {
        ...
        MutableComponent packName = new TranslatableComponent(info.getName());
    ...
    private MutableComponent getI18nFormatAuthor(List<String> authors) {
        ...
        return new TranslatableComponent("gui.touhou_little_maid.resources_download.author", str);
    }

    private MutableComponent getI18nFormatFileSize(String size) {
        return new TranslatableComponent("gui.touhou_little_maid.resources_download.file_size", size);
    }

    private MutableComponent getI18nFormatFileTime(String time) {
        return new TranslatableComponent("gui.touhou_little_maid.resources_download.upload_time", time);
    }

    private MutableComponent getI18nFormatLicense(String license) {
        return new TranslatableComponent("gui.touhou_little_maid.resources_download.license", license).withStyle(ChatFormatting.DARK_PURPLE).withStyle(ChatFormatting.ITALIC);
    }
