...
public class NewEntityFairyModel extends EntityModel<EntityFairy> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 15).addBox(-6.0F, -11.75F, -1.0F, 12.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(28, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(22, 23).addBox(-4.0F, -8.0688F, -4.205F, 8.0F, 13.0F, 8.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 6.0F, 0.0F));
        ...
        PartDefinition bone40 = head.addOrReplaceChild("bone40", CubeListBuilder.create().texOffs(0, 43).addBox(-3.75F, 0.25F, 0.25F, 8.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -0.2F, 3.8F, 0.2618F, 0.0F, 0.0F));

        PartDefinition bone5 = head.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(53, 41).addBox(-1.5F, 0.25F, 0.25F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(12, 12).addBox(-1.0F, 0.25F, -0.75F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 4.0F, 0.2618F, 0.0F, 0.0F));

        PartDefinition bone12 = head.addOrReplaceChild("bone12", CubeListBuilder.create().texOffs(88, 0).addBox(-3.0F, -1.75F, 0.25F, 6.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(80, 0).addBox(-1.0F, 0.25F, -0.75F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.2F, 4.5F, 0.0F, 0.0F, 0.0F));

        PartDefinition bone13 = head.addOrReplaceChild("bone13", CubeListBuilder.create().texOffs(68, 3).addBox(-1.25F, -1.5F, 1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(68, 0).addBox(-0.8F, -1.0F, 0.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.25F, -1.75F, 3.55F, 0.0F, 0.0F, -0.1745F));

        PartDefinition bone6 = head.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(54, 31).addBox(0.5F, -0.75F, -1.75F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 12).addBox(-1.25F, -0.25F, -0.75F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -7.0F, 2.0F, 0.0F, 0.0F, -0.1745F));

        PartDefinition bone7 = head.addOrReplaceChild("bone7", CubeListBuilder.create().texOffs(6, 12).addBox(-0.75F, -0.25F, -0.75F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(52, 51).addBox(-3.5F, -0.75F, -1.75F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -7.0F, 2.0F, 0.0F, 0.0F, 0.1745F));

        PartDefinition bone14 = head.addOrReplaceChild("bone14", CubeListBuilder.create().texOffs(74, 0).mirror().addBox(-1.2F, -1.0F, 0.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(78, 3).mirror().addBox(-1.75F, -1.5F, 1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.25F, -1.75F, 3.55F, 0.0F, 0.0F, 0.1745F));
        ...
        PartDefinition hair1 = og_hair.addOrReplaceChild("hair1", CubeListBuilder.create().texOffs(70, 12).addBox(-0.2F, 0.25F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));

        PartDefinition hair2 = og_hair.addOrReplaceChild("hair2", CubeListBuilder.create().texOffs(72, 12).addBox(-0.75F, 0.05F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2007F));

        PartDefinition hair7 = og_hair.addOrReplaceChild("hair7", CubeListBuilder.create().texOffs(74, 12).addBox(-0.75F, -0.25F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.9F, 0.0F, 0.0F, 0.0F, 0.0F, -0.2356F));

        PartDefinition hair3 = og_hair.addOrReplaceChild("hair3", CubeListBuilder.create().texOffs(76, 12).mirror().addBox(-0.8F, 0.25F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0436F));

        PartDefinition hair4 = og_hair.addOrReplaceChild("hair4", CubeListBuilder.create().texOffs(78, 12).mirror().addBox(-0.25F, 0.05F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1571F));

        PartDefinition hair5 = og_hair.addOrReplaceChild("hair5", CubeListBuilder.create().texOffs(80, 12).mirror().addBox(-0.25F, -0.25F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.9F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2356F));

        PartDefinition hair6 = og_hair.addOrReplaceChild("hair6", CubeListBuilder.create().texOffs(82, 12).addBox(-0.75F, 0.05F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.1571F));

        PartDefinition hair8 = og_hair.addOrReplaceChild("hair8", CubeListBuilder.create().texOffs(84, 12).mirror().addBox(-0.25F, 0.05F, 0.25F, 1.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.9F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2007F));

        PartDefinition armRight = partdefinition.addOrReplaceChild("armRight", CubeListBuilder.create().texOffs(32, 76).addBox(-1.7887F, 1.4532F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(41, 43).addBox(-2.2887F, 0.4532F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(12, 56).addBox(-2.2887F, 0.4532F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-1.0F, 6.5F, 0.0F, 0.0F, 0.0F, 0.4363F));

        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 44).addBox(-3.0F, -7.5F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-4.0F, -7.5F, -3.1F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.5F, 0.0F));
        ...
        PartDefinition skirt = sittingRotationSkirt.addOrReplaceChild("skirt", CubeListBuilder.create().texOffs(47, 22).addBox(-2.5F, -11.0F, -2.5F, 7.0F, 2.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(30, 16).addBox(-2.0F, -12.0F, -2.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 11.0F, -1.0F));
        ...
        PartDefinition skirtpart_right = bone52.addOrReplaceChild("skirtpart_right", CubeListBuilder.create().texOffs(10, 67).addBox(-2.5F, -5.5578F, -8.9415F, 5.0F, 9.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(10, 67).addBox(-2.5F, -5.5578F, -8.941F, 5.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.5F, 4.3705F, -0.1745F, 0.0F, 0.0F));
        ...
        PartDefinition legLeft = partdefinition.addOrReplaceChild("legLeft", CubeListBuilder.create().texOffs(12, 76).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(40, 57).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.2F)), PartPose.offset(2.0F, 15.0F, 0.0F));

        PartDefinition legRight = partdefinition.addOrReplaceChild("legRight", CubeListBuilder.create().texOffs(0, 76).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(40, 64).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.2F)), PartPose.offset(-2.0F, 15.0F, 0.0F));

        PartDefinition armLeft = partdefinition.addOrReplaceChild("armLeft", CubeListBuilder.create().texOffs(24, 76).addBox(-0.2113F, 1.4532F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(40, 50).addBox(-0.7113F, 0.4532F, -1.5F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 56).addBox(-0.7113F, 0.4532F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(1.0F, 6.5F, 0.0F, 0.0F, 0.0F, -0.4363F));

        PartDefinition wingLeft = partdefinition.addOrReplaceChild("wingLeft", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, 8.0F, 4.5F, 0.0F, 1.2217F, 0.0F));

        PartDefinition wingLeftUp = wingLeft.addOrReplaceChild("wingLeftUp", CubeListBuilder.create().texOffs(0, 7).mirror().addBox(0.0F, -2.2019F, 0.0716F, 0.0F, 9.0F, 15.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6981F, 0.0F, 0.0F));

        PartDefinition wingLeftDown = wingLeft.addOrReplaceChild("wingLeftDown", CubeListBuilder.create().texOffs(0, 20).addBox(0.0F, -1.4679F, 3.2856F, 0.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.0F));

        PartDefinition wingRight = partdefinition.addOrReplaceChild("wingRight", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.0F, 8.0F, 4.5F, 0.0F, -1.2217F, 0.0F));

        PartDefinition wingRightUp = wingRight.addOrReplaceChild("wingRightUp", CubeListBuilder.create().texOffs(0, 7).addBox(0.0F, -2.2019F, 0.0716F, 0.0F, 9.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6981F, 0.0F, 0.0F));

        PartDefinition wingRightDown = wingRight.addOrReplaceChild("wingRightDown", CubeListBuilder.create().texOffs(0, 20).mirror().addBox(0.0F, -1.4679F, 3.2856F, 0.0F, 6.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.6981F, 0.0F, 0.0F));
