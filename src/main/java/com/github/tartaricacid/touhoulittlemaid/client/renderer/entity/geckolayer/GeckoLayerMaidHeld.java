...
public class GeckoLayerMaidHeld<T extends Mob, R extends IGeoEntityRenderer<T>> extends GeoLayerMaidRender<T, R> {
    ...
    public GeoLayerMaidRender<T, R> create(R geckoEntityMaidRenderer, EntityRendererProvider.Context renderManager, Function<Mob, IGeoEntity> ysmGeoMob) {
        ...
        return new GeckoLayerMaidHeld<>(geckoEntityMaidRenderer, renderManager.getItemInHandRenderer());
    }
}
