...
public class GeckoLayerMaidBackItem2<T extends Mob, R extends IGeoEntityRenderer2<T>> extends GeoLayerMaidRender2<T, R> {
    public GeckoLayerMaidBackItem2(R entityRendererIn) {
    ...
    public GeoLayerMaidRender2<T, R> create(R geckoEntityMaidRenderer, EntityRendererProvider.Context renderManager, Function<Mob, IGeoEntity2> ysmGeoMob) {
        ...
        return new GeckoLayerMaidBackItem2<>(geckoEntityMaidRenderer);
    }
}
