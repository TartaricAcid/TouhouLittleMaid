...
public class GeckoLayerMaidBackpack2<T extends Mob, R extends IGeoEntityRenderer2<T>> extends GeoLayerMaidRender2<T, R> {

    public GeckoLayerMaidBackpack2(R entityRendererIn, EntityModelSet modelSet) {
    ...
    public GeoLayerMaidRender2<T, R> create(R geckoEntityMaidRenderer, EntityRendererProvider.Context renderManager, Function<Mob, IGeoEntity2> ysmGeoMob) {
        ...
        return new GeckoLayerMaidBackpack2<>(geckoEntityMaidRenderer, renderManager.getModelSet());
    }
}