...
public class GeckoLayerMaidBanner2<T extends Mob, R extends IGeoEntityRenderer2<T>> extends GeoLayerMaidRender2<T, R> {
    ...
    public GeckoLayerMaidBanner2(R renderer, EntityModelSet modelSet) {
        super(renderer);
    ...
    public GeoLayerMaidRender2<T, R> create(R geckoEntityMaidRenderer, EntityRendererProvider.Context renderManager, Function<Mob, IGeoEntity2> ysmGeoMob) {
        ...
        return new GeckoLayerMaidBanner2<>(geckoEntityMaidRenderer, renderManager.getModelSet());
    }
}
