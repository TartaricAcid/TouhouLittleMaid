...
public class GeckoLayerMaidBipedHead2<T extends Mob, R extends IGeoEntityRenderer2<T>> extends GeoLayerMaidRender2<T, R> {
    private static final String SKULL_OWNER_TAG = "SkullOwner";
    private final Map<SkullBlock.Type, SkullModelBase> skullModels;

    public GeckoLayerMaidBipedHead2(R entityRendererIn, EntityModelSet modelSet) {
    ...
    public GeoLayerMaidRender2<T, R> create(R geckoEntityMaidRenderer, EntityRendererProvider.Context renderManager, Function<Mob, IGeoEntity2> ysmGeoMob) {
        ...
        return new GeckoLayerMaidBipedHead2<>(geckoEntityMaidRenderer, renderManager.getModelSet());
    }
}
