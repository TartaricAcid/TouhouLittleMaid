...
public class TileEntityEntityPlaceholderRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    @Override
    public void renderByItem(ItemStack stack, ItemTransforms.TransformType transformType, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLight, int combinedOverlay) {
        poseStack.pushPose();
