...
public class ClientBoardStateTooltip implements ClientTooltipComponent {
    private static final ResourceLocation GOMOKU_BG = new ResourceLocation(TouhouLittleMaid.MOD_ID, "textures/gui/gomoku.png");
    private static final ResourceLocation XIANGQI_BG = new ResourceLocation(TouhouLittleMaid.MOD_ID, "textures/gui/xiangqi.png");
    private static final ResourceLocation CHESS_BG = new ResourceLocation(TouhouLittleMaid.MOD_ID, "textures/gui/chess.png");
