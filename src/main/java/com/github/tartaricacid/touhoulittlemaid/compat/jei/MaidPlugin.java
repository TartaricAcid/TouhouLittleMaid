...
public class MaidPlugin implements IModPlugin {
    ...
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration.addRecipeTransferHandler(CraftingTableBackpackContainer.class, RecipeTypes.CRAFTING, 71, 9, 0, 70);
        registration.addRecipeTransferHandler(FurnaceBackpackContainer.class, RecipeTypes.SMELTING, 70, 1, 0, 70);
        registration.addRecipeTransferHandler(FurnaceBackpackContainer.class, RecipeTypes.FUELING, 71, 1, 0, 70);
    }
