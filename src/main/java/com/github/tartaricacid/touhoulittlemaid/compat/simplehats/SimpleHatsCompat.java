...
public class SimpleHatsCompat {
    ...
    public static void renderGeckoHat(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, Mob mob, ItemStack stack, List<? extends IBaseBone> model) {
        if (isLoaded) {
