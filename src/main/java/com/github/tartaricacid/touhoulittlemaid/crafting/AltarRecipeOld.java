...
//
//    public AltarRecipe(ResourceLocation id, Holder<EntityType<?>> entityType, @Nullable CompoundTag extraData, float powerCost, Ingredient copyInput, @Nullable String copyTag, NonNullList<Ingredient> inputs) {
//        this.id = id;
...
//            nbt.putString("id", Objects.requireNonNull(BuiltInRegistries.ENTITY_TYPE.getKey(entityType.value())).toString());
...
//            return;
//        }
//        entityType.value().spawn(world, null, (Player) null, pos, MobSpawnType.SPAWN_EGG, true, true);
//    }
//
