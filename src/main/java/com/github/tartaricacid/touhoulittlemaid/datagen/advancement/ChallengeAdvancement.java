...
public class ChallengeAdvancement {
    ...
    private static void generateProtect(Advancement root, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        ...
        make(Items.NETHERITE_CHESTPLATE, "all_netherite_equipment").parent(protect)
        ...
        make(InitItems.ULTRAMARINE_ORB_ELIXIR.get(), "all_protect_bauble").parent(protect)
                .addCriterion("maid_event", MaidEventTrigger.create(TriggerType.ALL_PROTECT_BAUBLE))
                .save(saver, id("challenge/all_protect_bauble"), existingFileHelper);
        ...
        make(Items.NETHERITE_CHESTPLATE, "maid_100_healthy").parent(protect)
    ...
    private static void generateOther(Advancement root, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        ...
        make(Items.DIAMOND_SWORD, "maid_fishing_enchanted_book").parent(kill)
        ...
        make(Items.DIAMOND_SWORD, "maid_in_dungeon").parent(kill)
                .addCriterion("maid_event", MaidEventTrigger.create(TriggerType.MAID_IN_DUNGEON))
                .save(saver, id("challenge/maid_in_dungeon"), existingFileHelper);

        make(Items.DIAMOND_SWORD, "tamed_maid_in_pillager_outpost").parent(kill)
                .addCriterion("maid_event", MaidEventTrigger.create(TriggerType.TAMED_MAID_IN_PILLAGER_OUTPOST))
                .save(saver, id("challenge/tamed_maid_in_pillager_outpost"), existingFileHelper);

        make(Items.DIAMOND_SWORD, "kill_dragon").parent(kill)
