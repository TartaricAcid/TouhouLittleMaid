...
public final class MaidBrain {
    ...
    private static void registerCoreGoals(Brain<EntityMaid> brain) {
        ...
        Pair<Integer, Behavior<? super EntityMaid>> interactWithDoor = Pair.of(2, new InteractWithDoor());
        Pair<Integer, Behavior<? super EntityMaid>> walkToTarget = Pair.of(2, new MoveToTargetSink());
        Pair<Integer, Behavior<? super EntityMaid>> followOwner = Pair.of(3, new MaidFollowOwnerTask(0.5f, 8, 2));
        Pair<Integer, Behavior<? super EntityMaid>> pickupItem = Pair.of(10, new MaidPickupEntitiesTask(EntityMaid::isPickup, 8, 0.6f));
        Pair<Integer, Behavior<? super EntityMaid>> maidReturnHome = Pair.of(20, new MaidReturnHomeTask(0.5f));
    ...
    private static void registerIdleGoals(Brain<EntityMaid> brain) {
        ...
        Pair<Behavior<? super EntityMaid>, Integer> noLook = Pair.of(new DoNothing(40, 80), 2);
        ...
        RunIf<EntityMaid> supplementedTask = new RunIf<>(MaidBrain::lookAroundCondition, firstShuffledTask);

        Pair<Integer, Behavior<? super EntityMaid>> beg = Pair.of(5, new MaidBegTask());
        Pair<Integer, Behavior<? super EntityMaid>> findJoy = Pair.of(6, new MaidFindJoyTask(0.6f, 12));
        Pair<Integer, Behavior<? super EntityMaid>> sitJoy = Pair.of(7, new MaidSitJoyTask());
        Pair<Integer, Behavior<? super EntityMaid>> supplemented = Pair.of(10, supplementedTask);
        Pair<Integer, Behavior<? super EntityMaid>> updateActivity = Pair.of(99, new UpdateActivityFromSchedule());
    ...
    private static void registerRestGoals(Brain<EntityMaid> brain) {
        Pair<Integer, Behavior<? super EntityMaid>> findBed = Pair.of(5, new MaidFindBedTask(0.6f, 12));
        Pair<Integer, Behavior<? super EntityMaid>> sleep = Pair.of(6, new MaidSleepTask());
        Pair<Integer, Behavior<? super EntityMaid>> updateActivity = Pair.of(99, new UpdateActivityFromSchedule());
    ...
    private static void registerPanicGoals(Brain<EntityMaid> brain) {
        ...
        Pair<Integer, Behavior<? super EntityMaid>> runAway = Pair.of(5, MaidRunAwayTask.entity(MemoryModuleType.NEAREST_HOSTILE, 0.7f, 6, false));
        Pair<Integer, Behavior<? super EntityMaid>> runAwayHurt = Pair.of(5, MaidRunAwayTask.entity(MemoryModuleType.HURT_BY_ENTITY, 0.7f, 6, false));
    ...
    private static void registerAwaitGoals(Brain<EntityMaid> brain) {
        ...
        Pair<Integer, Behavior<? super EntityMaid>> shuffled = Pair.of(5, new RunIf<>(MaidBrain::lookAroundCondition, firstShuffledTask));
        Pair<Integer, Behavior<? super EntityMaid>> updateActivity = Pair.of(99, new UpdateActivityFromSchedule());
