...
public final class InitContainer {
    ...
    public static final RegistryObject<MenuType<BaubleContainer>> MAID_BAUBLE_CONTAINER = CONTAINER_TYPE.register("maid_bauble_container", () -> BaubleContainer.TYPE);
    ...
    public static final RegistryObject<MenuType<MaidAIChatConfigContainer>> MAID_AI_CHAT_CONFIG_CONTAINER = CONTAINER_TYPE.register("maid_ai_chat_config_container", () -> MaidAIChatConfigContainer.TYPE);
    ...
    public static final RegistryObject<MenuType<AttackTaskConfigContainer>> ATTACK_TASK_CONFIG = CONTAINER_TYPE.register("attack_task_config_container", () -> AttackTaskConfigContainer.TYPE);
}
