...
public final class InitEntities {
    ...
    public static RegistryObject< MemoryModuleType<Set<GlobalPos>>> FENCE_GATE_TO_CLOSE = MEMORY_MODULE_TYPES.register("fence_gate_to_close", () -> new MemoryModuleType<>(Optional.empty()));
