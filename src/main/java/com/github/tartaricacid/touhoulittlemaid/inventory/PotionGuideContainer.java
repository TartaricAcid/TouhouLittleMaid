...
public class PotionGuideContainer extends Container {
    private final ItemStack guide;
    private final ItemStackHandler itemStackHandler;

    public PotionGuideContainer(IInventory playerInventory, ItemStack guide) {
        this.guide = guide;
        this.itemStackHandler = ItemPotionGuide.getGuideInv(guide);
    ...
    public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, EntityPlayer player) {
        ...
        ItemPotionGuide.setGuideInv(guide, itemStackHandler);
        return stack;
    }
    ...
    private void addGuideSlots() {
        for (int l = 0; l < 6; ++l) {
            this.addSlotToContainer(new GuideSlotItemHandler(itemStackHandler, l, 8 + l * 18, 12));
        }
    }
    ...
    public boolean canInteractWith(@Nonnull EntityPlayer playerIn) {
        return playerIn.getHeldItemMainhand().getItem() instanceof ItemPotionGuide;
    }

    private static class GuideSlotItemHandler extends SlotItemHandler {
        private GuideSlotItemHandler(IItemHandler itemHandler, int index, int xPosition, int yPosition) {
