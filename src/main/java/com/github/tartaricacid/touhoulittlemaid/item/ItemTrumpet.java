            ...
            if (worldIn instanceof ServerWorld) {
                ...
                if (data != null) {
                    ...
                    if (infos != null && !infos.isEmpty()) {
                        player.sendMessage(new TranslationTextComponent("message.touhou_little_maid.trumpet.unloaded_maid", infos.size()).withStyle(TextFormatting.DARK_RED), Util.NIL_UUID);
                    }
                }
            }
